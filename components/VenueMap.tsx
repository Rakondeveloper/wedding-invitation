...
export default function VenueMap() {
  ...
  return (
    ...
    >
      ...
      <div className="section-content relative z-10 flex w-full max-w-sm sm:max-w-md items-center justify-center gap-2 sm:gap-5 px-2 sm:px-0">
        {/* Google Maps Button */}
        <a
          href={VENUE_DETAILS.googleMapsUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="group flex-1 sm:flex-initial inline-flex h-10 sm:h-12 items-center justify-center gap-1.5 sm:gap-2 rounded-full border border-gold/40 bg-emerald-regal px-2.5 sm:px-6 text-[10px] sm:text-xs font-semibold uppercase tracking-wider sm:tracking-widest2 text-gold-bright shadow-lg transition-all hover:scale-103 whitespace-nowrap"
        >
